...
namespace Harmonic.Subtitles
{
	public static class ErrorHandler
	{
		public static void Application_ThreadException(object sender, ThreadExceptionEventArgs e)
		{
			...
			Log(e.Exception, AppDomain.CurrentDomain.FriendlyName + " error.xml");
		}
		...
		public static void CurrentDomain_UnhandledException(object sender, UnhandledExceptionEventArgs e)
		{
			...
			Log((e.ExceptionObject as Exception), AppDomain.CurrentDomain.FriendlyName + " error.xml");
		}
		...
		private static XElement ErrorNode(Exception ex, String nodeName)
		{
			if (ex==null)
				return null;
